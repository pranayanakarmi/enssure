...
* @see app/Http/Controllers/Admin/PageController.php:63
...
* @see app/Http/Controllers/Admin/PageController.php:84
...
* @see app/Http/Controllers/Admin/PageController.php:100
* @route '/admin/pages/{page}'
*/
