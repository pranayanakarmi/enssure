...
* @see app/Http/Controllers/Admin/DocumentController.php:15
...
* @see app/Http/Controllers/Admin/DocumentController.php:36
...
* @see app/Http/Controllers/Admin/DocumentController.php:78
* @route '/admin/documents/{document}'
*/
