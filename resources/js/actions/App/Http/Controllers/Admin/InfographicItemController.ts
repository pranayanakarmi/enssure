...
* @route '/admin/infographics/{infographic}/items/reorder'
*/
const reorderForm = (args: { infographic: string | number | { slug: string | number } } | [infographic: string | number | { slug: string | number } ] | string | number | { slug: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/infographics/{infographic}/items/reorder'
*/
reorderForm.post = (args: { infographic: string | number | { slug: string | number } } | [infographic: string | number | { slug: string | number } ] | string | number | { slug: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: reorder.url(args, options),
    method: 'post',
})
...
* @route '/admin/infographics/{infographic}/items'
*/
const storeForm = (args: { infographic: string | number | { slug: string | number } } | [infographic: string | number | { slug: string | number } ] | string | number | { slug: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/infographics/{infographic}/items'
*/
storeForm.post = (args: { infographic: string | number | { slug: string | number } } | [infographic: string | number | { slug: string | number } ] | string | number | { slug: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: store.url(args, options),
    method: 'post',
})
...
* @route '/admin/infographic-items/{infographic_item}/edit'
*/
const editForm = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/admin/infographic-items/{infographic_item}/edit'
*/
editForm.get = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: edit.url(args, options),
    method: 'get',
})
...
* @route '/admin/infographic-items/{infographic_item}/edit'
*/
editForm.head = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/admin/infographic-items/{infographic_item}'
*/
const updateForm = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/infographic-items/{infographic_item}'
*/
updateForm.put = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @route '/admin/infographic-items/{infographic_item}'
*/
const destroyForm = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/infographic-items/{infographic_item}'
*/
destroyForm.delete = (args: { infographic_item: string | number | { id: string | number } } | [infographic_item: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroy.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
