...
const form = useForm({
    ...
    sort_order: props.infographic.sort_order ?? 0,
    image: null,
});
...
const displayImageUrl = computed(() => imagePreviewUrl.value ?? props.infographic.image_url);
...
const submitUrl = computed(() => `/admin/infographics/${props.infographic.id}`);
</script>
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="space-y-6">
                <Heading variant="small" title="Edit infographic" description="Update title, order, or replace the image" />
                <form
                    class="space-y-6"
                    @submit.prevent="form.put(submitUrl, { forceFormData: true })"
                >
                        ...
                        >
                            ...
                            >
                                <p class="text-xs text-muted-foreground">
                                    New image selected. Save to replace the current file.
                                </p>
                                <button
                                    type="button"
