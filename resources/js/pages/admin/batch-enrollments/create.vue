...
const breadcrumbItems = [
    ...
    { title: 'Create', href: '/admin/batch_enrollments/create' },
];
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Create batch enrollment" />
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="space-y-6">
                <Heading variant="small" title="Create batch enrollment" description="Add a new enrollment" />
                <form class="space-y-6" @submit.prevent="form.post('/admin/batch_enrollments')">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <Button variant="outline" as-child>
                            <Link href="/admin/batch_enrollments">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
