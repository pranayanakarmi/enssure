            ...
            <div class="space-y-6">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <Heading
                        ...
                        description="Manage impact stories"
                    />
                    <Button as-child>
                        <Link href="/admin/impact_stories/create">Add story</Link>
                    </Button>
                </div>
                ...
                <Card>
                    <CardHeader class="sr-only">
                        <span>Impact stories list</span>
                    </CardHeader>
                    <CardContent class="p-0">
                        <div class="divide-y divide-sidebar-border">
                            <div
                                v-for="s in (impactStories || [])"
                                :key="s.id"
                            ...
                            >
                                ...
                                <div class="flex items-center gap-2">
                                    <Button variant="outline" size="sm" as-child>
                                        <Link :href="`/admin/impact_stories/${s.id}/edit`">
                                            Edit
                                        </Link>
                                    </Button>
                                </div>
