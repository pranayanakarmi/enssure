...
import { ChevronDown, ChevronsUpDown, Edit, Mail, MessageSquare } from 'lucide-vue-next';
...
const groups = [
  {
    ...
    dot: 'bg-blue-500',
    sections: [
      { title: 'Contact Us page', description: 'Edit the page content (text, map, etc.)', href: '/admin/contact-feedback-content/edit', icon: Edit },
      { title: 'Feedback submissions', description: 'View and manage user feedback', href: '/admin/feedback', icon: MessageSquare },
    ],
  },
];
  ...
  <AppLayout :breadcrumbs="breadcrumbItems">
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">Contact Us</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage the contact page content and view feedback from users.
          </p>
        </div>
