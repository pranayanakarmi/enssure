...
const form = useForm({
    province_id: props.district.province_id ?? '',
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="space-y-6">
                <Heading variant="small" title="Edit district" :description="district.name" />
                <form class="space-y-6" @submit.prevent="form.put(`/admin/districts/${district.id}`)">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <Button variant="outline" as-child>
                            <Link href="/admin/districts">Back</Link>
                        </Button>
                    </div>
                </form>
            </div>
