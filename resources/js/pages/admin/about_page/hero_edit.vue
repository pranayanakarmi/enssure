...
function submitForm() {
    form.post('/admin/about-page/hero', {
        forceFormData: true,
    });
}
        ...
        <div class="flex h-full flex-1 flex-col gap-5 overflow-x-auto p-5">
            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold tracking-tight text-foreground">About Page – Hero</h1>
            ...
            <Card class="border-gray-200 shadow-sm">
                <CardHeader class="border-b border-gray-200 px-5 py-4">
                    ...
                    <CardDescription class="text-xs">Update the title and background image for the About page hero.</CardDescription>
                </CardHeader>
                <CardContent class="px-5 py-5">
                    <form class="flex flex-col gap-5" @submit.prevent="submitForm">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <Input id="title" v-model="form.title" class="h-9 text-sm" placeholder="e.g. About Us" />
