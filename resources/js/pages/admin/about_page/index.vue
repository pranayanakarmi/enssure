...
import { ChevronDown, ChevronsUpDown, Edit, Image, FileText, LayoutPanelLeft } from 'lucide-vue-next';
...
const groups = [
  {
    ...
    dot: 'bg-blue-500',
    sections: [
      { title: 'Hero', description: 'Edit the hero image and title', href: '/admin/about-page/hero/edit', icon: Image },
      { title: 'Main section', description: 'Update main content and images', href: '/admin/about-page/main-section/edit', icon: FileText },
      { title: 'Content section', description: 'Manage additional text content', href: '/admin/about-page/content-section/edit', icon: LayoutPanelLeft },
    ],
  },
];
  ...
  <AppLayout :breadcrumbs="breadcrumbItems">
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">About Page</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage the hero section, main content, and additional text sections.
          </p>
        </div>
