...
const groups = [
  {
    ...
    dot: 'bg-purple-500',
    sections: [
      { title: 'Title & Text', description: 'Edit page heading and description', href: '/admin/gallery-page/section/edit', icon: FileText },
      { title: 'Albums', description: 'Manage photo albums and images', href: '/admin/galleries', icon: Images },
    ],
  },
];
...
<template>
  <AppLayout :breadcrumbs="breadcrumbItems">
    <Head title="Gallery Page Management" />
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">Gallery Page</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage the gallery page title, description and photo albums.
          </p>
        </div>
