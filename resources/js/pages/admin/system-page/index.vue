...
import { ChevronDown, ChevronsUpDown, Edit, Mail, Link as LinkIcon, Image, Settings } from 'lucide-vue-next';
...
const groups = [
  {
    ...
    dot: 'bg-gray-500',
    sections: [
      { title: 'Settings', description: 'Manage application settings', href: '/admin/settings', icon: Settings },
      { title: 'Email Templates', description: 'Manage email templates', href: '/admin/email_templates', icon: Mail },
      { title: 'Redirects', description: 'Manage URL redirects', href: '/admin/redirects', icon: LinkIcon },
      { title: 'Media', description: 'Manage media files', href: '/admin/media', icon: Image },
    ],
  },
];
...
const breadcrumbItems = [
  ...
  { title: 'System', href: '/admin/system-page' },
];
</script>
  ...
  <AppLayout :breadcrumbs="breadcrumbItems">
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">System</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage application settings, email templates, redirects, and media.
          </p>
        </div>
