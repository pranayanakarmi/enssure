...
function deletePage() {
    ...
    router.delete(`/admin/pages/${pageToDelete.value.id}`, {
        preserveScroll: true,
        onFinish: () => {
        ...
        <div class="flex h-full flex-1 flex-col gap-5 overflow-x-auto p-5">
            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold tracking-tight text-foreground">All Pages</h1>
                        <p class="text-xs text-muted-foreground mt-0.5">Manage website pages (drafts are not publicly visible).</p>
                    </div>
                </div>
            ...
            <!-- Pages Table (without Parent column) -->
            <Card class="border-gray-200 shadow-sm">
                <CardHeader class="border-b border-gray-200 px-5 py-4">
                    <CardTitle class="text-sm font-semibold">Pages List</CardTitle>
                    <CardDescription class="text-xs">Click Edit to modify a page or Delete to remove.</CardDescription>
                </CardHeader>
                        ...
                        <table class="w-full text-sm">
                            <thead class="border-b border-gray-200 bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left font-medium">Published Date</th>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3">
                                        <Badge :variant="p.published_at ? 'default' : 'secondary'">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <div class="flex justify-end gap-2">
                                            <Button
                                                ...
                                                as-child
                                            >
                                                <a :href="`/pages/${p.slug}`" target="_blank" rel="noopener noreferrer">
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" @click.self="showDeleteModal = false">
            <div class="w-full max-w-md rounded-lg bg-background p-6 shadow-lg">
                ...
                <p class="mt-2 text-sm text-muted-foreground">
                    Are you sure you want to delete “{{ pageToDelete?.title }}”?<br>
                    This action cannot be undone.
                </p>
                <div class="mt-6 flex justify-end gap-2">
                    <Button variant="outline" size="sm" @click="showDeleteModal = false">Cancel</Button>
                    <Button variant="destructive" size="sm" @click="deletePage" :disabled="isDeleting">
