...
import { ChevronDown, ChevronsUpDown, Edit, FileText, Image } from 'lucide-vue-next';
...
const groups = [
  {
    ...
    dot: 'bg-indigo-500',
    sections: [
      { title: 'All pages', description: 'Manage all pages (create, edit, delete)', href: '/admin/pages', icon: FileText },
      { title: 'Hero background', description: 'Edit the global hero background image', href: '/admin/pages/hero/edit', icon: Image },
    ],
  },
];
  ...
  <AppLayout :breadcrumbs="breadcrumbItems">
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">Pages</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage the content and hero background for your website pages.
          </p>
        </div>
