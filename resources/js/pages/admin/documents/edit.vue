...
const form = useForm({
    ...
    document_type: props.document.document_type ?? 'report',
        ...
        <div class="flex h-full flex-1 flex-col gap-5 overflow-x-auto p-5">
            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold tracking-tight text-foreground">Edit Document</h1>
                        <p class="text-xs text-muted-foreground mt-0.5">{{ document.title }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs text-gray-600">
                    <FileText class="h-3.5 w-3.5" />Edit Document
                </div>
            </div>
            ...
            <Card class="border-gray-200 shadow-sm">
                <CardHeader class="border-b border-gray-200 px-5 py-4">
                    ...
                    <CardDescription class="text-xs">Update the document information.</CardDescription>
                </CardHeader>
                <CardContent class="px-5 py-5">
                    <form class="flex flex-col gap-5" @submit.prevent="updateDocument">
                        ...
                        <!-- PDF Preview Card (unchanged but styled consistently) -->
                        <div class="flex flex-col gap-1.5">
                            <Label class="text-xs font-medium">Current PDF Preview</Label>
                            <Card class="border-gray-200 shadow-sm">
                                <CardHeader class="pb-3 border-b border-gray-200">
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <a
                                                ...
                                                class="inline-flex h-7 items-center justify-center rounded-md border border-gray-300 bg-background px-3 text-xs font-medium hover:bg-gray-50"
                                            >
                                                Open in new tab
                                            </a>
                                            <a
                                ...
                                <CardContent class="p-4">
                                    <iframe
                                        ...
                                        class="h-[28rem] w-full rounded-md border border-gray-200 bg-gray-50"
                                    />
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <div class="flex flex-col gap-1.5">
                            <Label for="file" class="text-xs font-medium">Replace PDF (optional)</Label>
                            <input
                                id="file"
                                type="file"
