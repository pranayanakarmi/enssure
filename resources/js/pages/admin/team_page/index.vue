...
import { ChevronDown, ChevronsUpDown, Edit, FileText, Users, UsersRound } from 'lucide-vue-next';
...
const groups = [
  {
    ...
    dot: 'bg-indigo-500',
    sections: [
      { title: 'Content', description: 'Edit page heading and description', href: '/admin/team-page/content/edit', icon: FileText },
      { title: 'Executive Committee', description: 'Manage executive committee members', href: '/admin/team_members/executive', icon: Users },
      { title: 'Staff', description: 'Manage staff members', href: '/admin/team_members/staff', icon: UsersRound },
    ],
  },
];
  ...
  <AppLayout :breadcrumbs="breadcrumbItems">
    ...
    <div class="flex h-full flex-1 flex-col gap-8 overflow-x-auto p-6">
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight text-foreground">Our Team</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Manage team page content, executive committee members, and staff.
          </p>
        </div>
