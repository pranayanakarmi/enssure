...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Edit Team Page Content" />
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="space-y-6">
                <Heading
                    variant="small"
                    title="Team Page Content"
                    description="Edit the banner title, description and background image shown on the Our Team page."
                />
                <form
                    class="space-y-6"
                    @submit.prevent="form.put('/admin/team-page/content', { forceFormData: true })"
                >
