...
const storyImageUrl = computed(() => props.impactStory.image_url ?? defaultImage);
...
<template>
    <GuestLayout>
        <Head :title="`${impactStory.title} - Impact Stories - ENSSURE`">
            <meta property="og:title" :content="`${impactStory.title} - ENSSURE`" />
            <meta
                v-if="impactStory.image_url"
                property="og:image"
                :content="impactStory.image_url"
            />
        </Head>
